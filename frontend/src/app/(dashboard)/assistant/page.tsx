...
export default function AssistantPage() {
  return (
    <div className="flex h-[80vh] flex-col items-center justify-center text-center">
      ...
      <h2 className="mt-6 text-2xl font-semibold text-slate-900">AI Assistant Chat</h2>
      <p className="mt-2 text-slate-500 max-w-sm">
        Agentic interface for querying your enterprise data with LLMs and LangGraph tools.
      </p>
      <div className="mt-8">
